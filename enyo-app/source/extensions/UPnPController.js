...
/*						{content: "--:--", className: "enyo-label", style: "color: gray;font-size: 12px;"}*/
        ...
        {kind: "PalmService", name: "upnpDiscover", service: "palm://org.webosinternals.homecontrol.service.upnp", method: "discover",
            onSuccess: "discoverySuccess", onFailure: "discoveryFailure"
        },
        {kind: "PalmService", name: "upnpCommand", service: "palm://org.webosinternals.homecontrol.service.upnp", method: "sendCommand",
    ...
    openPortSuccess: function(inSender, inResponse) {
        ...
        this.$.upnpDiscover.call({"timeout": 30});
    },
    ...
    discoverySuccess: function(inSender, inResponse) {
        enyo.error("Found these devices: " + enyo.json.stringify(inResponse));
    },
